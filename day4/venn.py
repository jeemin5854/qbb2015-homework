...
v.get_label_by_id('110').set_text(CTCF_BEAF_overlap )
v.get_label_by_id('001').set_text(SU_only)
v.get_label_by_id('101').set_text(CTCF_SU_overlap)
v.get_label_by_id('011').set_text(BEAF_SU_overlap)
v.get_label_by_id('111').set_text(three_overlap)
#Colors
